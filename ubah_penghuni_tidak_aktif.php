...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['simpan'])) {
        ...
        $result = ubahPenghuniTidakAktif($_POST, $id_penghuni);
        if ($result === true) {
            echo '
            <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.18"></script>
            <script>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <input type="date" class="form-control" id="tanggal_masuk" name="tanggal_masuk" value="<?= $up['tanggal_masuk_penghuni']; ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <input type="text" class="form-control" name="tanda_jadi" id="tanda_jadi" value="<?php echo $total_tagihan_tanda_jadi; ?>">
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <h4 class="card-title mt-1">Akun Penghuni</h4>

                    <h5 class="card-title mt-4">Username</h5>
                    <h6>
                        <span id="wajibdiisi">Username Hanya Dapat Diubah Oleh Penghuni</span>
                    </h6>
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Masukkan Username Untuk Penghuni" name="username" id="username" value="<?= $up['username']; ?>" readonly>
                            </div>
                        </div>
                    </div>
