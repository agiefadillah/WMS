        ...
        echo '
            ...
            <script>
                Swal.fire({
                    ...
                    window.location.href = "index.php?page=ubah_check_out" + data;
                });
            </script>';
    }
}

$id_check_out = $_GET['id_checkout'];
$uco = query("SELECT co.*, u.nama AS nama_penghuni, k.*, p.*
              FROM check_out co
              INNER JOIN kamar k ON co.id_kamar = k.id_kamar
              INNER JOIN penghuni p ON co.id_penghuni = p.id_penghuni
              INNER JOIN users u ON p.id_users = u.id_users
              WHERE co.id_checkout='$id_check_out'")[0];
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title text-truncate text-dark font-weight-medium mb-1">Kamar <?php echo $uco["nomor_kamar"] ?></h5>
                    <h6><?= 'Rp. ' . number_format($uco['harga_kamar']) ?></h6>

                    <form action="" method="POST">
                        <input type="hidden" name="id_checkout" value="<?= $uco['id_checkout']; ?>">
                        <input type="hidden" name="id_penghuni" value="<?= $uco['id_penghuni']; ?>">

                        <h5 class="card-title mt-4">Nama Penghuni</h5>
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="nama_penghuni" value="<?= $uco['nama_penghuni']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    <input type="date" class="form-control" name="tanggal_masuk" value="<?= $uco['tanggal_masuk_penghuni']; ?>" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    <input type="date" class="form-control" name="tanggal_checkout" value="<?= $uco['tanggal_keluar_penghuni']; ?>" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        $tagihan = query("SELECT * FROM tagihan WHERE id_penghuni = '" . $uco['id_penghuni'] . "' ORDER BY 
                                        CASE 
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <div class="form-group">
                                    <textarea class="form-control" rows="2" name="keterangan_checkout" id="keterangan_checkout"><?= $uco['keterangan_checkout']; ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm mt-4">
                            ...
                            <a href="index.php?page=riwayat_check_out" class="btn btn-primary">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
