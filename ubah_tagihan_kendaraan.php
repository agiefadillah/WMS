...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title">Ubah Tagihan Kendaraan</h3>
                    <form action="" method="POST">
                        ...
                        <h5 class="card-title mt-4">Tanggal Tagihan Kendaraan</h5>
                        <div class="col-sm">
                        ...
                        <div class="col-sm">
                            <select class="form-control" name="id_penghuni" id="id_penghuni">
                        ...
                        <div class="col-sm">
                            <input type="text" class="form-control" name="deskripsi_tagihan" placeholder="Masukkan Deskripsi Tagihan Kendaraan | Contoh: Sewa Kamar Januari 2023" value="<?= $ubah_tagihan['deskripsi_tagihan']; ?>">
                        </div>

                        <h5 class="card-title mt-4">Jumlah Tagihan Kendaraan</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control" name="jumlah_tagihan" id="jumlah_tagihan" placeholder="Masukkan Jumlah Tagihan Kendaraan | Contoh: 1500000" value="<?= $ubah_tagihan['jumlah_tagihan']; ?>">
                        </div>

                        <h5 class="card-title mt-4">Keterangan Tagihan Kendaraan</h5>
                        <div class="col-sm">
                            <input type="text" class="form-control" name="keterangan_tagihan" placeholder="Masukkan Keterangan Tagihan Kendaraan" value="<?= $ubah_tagihan['keterangan_tagihan']; ?>">
                        </div>
