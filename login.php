...
function login()
{
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
        ...
        if (!verifyCSRFToken($_POST['csrf_token'])) {
            $_SESSION['login_error'] = 'CSRF Token tidak valid.';
        ...
        if (mysqli_num_rows($result) == 1) {
            ...
            $_SESSION['login_error'] = 'Email, Username atau Nomor Telepon Tidak Ditemukan';
        }
                            ...
                            <div class="card-body">
                                ...
                                <form action="" method="POST" style="max-width: 400px; margin: 0 auto;">
                                    ...
                                    <div class="form-group">
                                        <label for="username_email_kontak" class="sr-only">Email</label>
                                        <input type="text" name="username_email_kontak" id="username_email_kontak" class="form-control" placeholder="Email, Username, atau Nomor Telepon" required>
                                    </div>
                                    <div class="form-group">
